    ...
    <div class="col-md-8">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <label for="code"
                        class="col-md-4 col-form-label text-md-end text-start"><strong>Cód.:</strong></label>
                ...
                <div class="row">
                    <label for="price"
                        class="col-md-4 col-form-label text-md-end text-start"><strong>Valor:</strong></label>
                    <div class="col-md-6" style="line-height: 35px;">
                        R$ {{ $product->price }}
                    </div>
                </div>
